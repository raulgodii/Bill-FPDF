...
//Añadimos los colores de fondo y de borde.
$pdf->SetFillColor(252,169,90);
$pdf->SetDrawColor(200,100,50);

// En esta parte estan los encabezados
$pdf->SetFont('Arial','B',10);
$pdf->Cell(20, 7, utf8_decode('Cod'),1,0,'C',1);
$pdf->Cell(95, 7, utf8_decode('Descripción'),1,0,'C',1);
$pdf->Cell(20, 7, utf8_decode('Cant'),1,0,'C',1);
$pdf->Cell(25, 7, utf8_decode('Precio'),1,0,'C',1);
...
//Aqui inicia el for con todos los productos
    $productos = [
        ["LG OLED48C24LA 48\" OLED UltraHD 4K HDR10 Pro", 20, 949.99 . EURO, 18999.8 . EURO],
        ["LG OLED83C24LA 83\" OLED UltraHD 4K HDR10 Pro", 15, 3698.99 . EURO, 55484.85 . EURO],
        ["Samsung Galaxy Book3 Intel Core i5-1335U", 25, 799 . EURO, 19975 . EURO],
        ["Alurin Flex Advance Intel Core i5-1155G7", 30, 605 . EURO, 18150 . EURO],
        ["Lenovo V15 G2 ITL Intel Core i3-1115G4", 18, 424.99 . EURO, 7649.82 . EURO]
    ];
    ...
    $pdf->setX(95);
    $pdf->Cell(40, 6, 'Descuento', 1, 0, 'C',1);
